...
The packages in the `navigation_msgs` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy navigation_msgs --override-release-repository-push-url git@github.com:revyos-ros/navigation_msgs-release.git` on `Sun, 16 Jun 2024 15:20:25 -0000`
...
- release repository: https://github.com/revyos-ros/navigation_msgs-release.git
